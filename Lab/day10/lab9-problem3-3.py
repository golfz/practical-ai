...
plt.scatter(X_normalized[:, 0], X_normalized[:, 1], marker="o", label="Original", facecolors="none", edgecolors="b",
            s=15)
plt.scatter(X_recovered[:, 0], X_recovered[:, 1], marker="o", label="Approximation", facecolors="none", edgecolors="r",
            s=15)
