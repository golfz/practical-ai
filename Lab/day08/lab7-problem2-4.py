...
J_train_polynomial_lambda1, J_cv_polynomial_lambda1 = learningCurve(
    initial_theta_polynomial,
    X_train_polynomial_normalized,
    y_train,
    X_cv_polynomial_normalized,
    y_cv,
    1
)
...
J_train_polynomial_lambda100, J_cv_polynomial_lambda100 = learningCurve(
    initial_theta_polynomial,
    X_train_polynomial_normalized,
    y_train,
    X_cv_polynomial_normalized,
