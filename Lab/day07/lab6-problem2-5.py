...
def costfunction(Theta1, Theta2, X_with_bias, y_one_hot, lambda_param):
    ...
    theta1_grad = (big_delta1 / number_of_examples) + ((lambda_param * Theta1_) / number_of_examples)
    theta2_grad = (big_delta2 / number_of_examples) + ((lambda_param * Theta2_) / number_of_examples)
